...
import Contract.Monad (liftContractE, liftContractM, liftedM)
...
import Seabug.Types (MarketplaceDatum(MarketplaceDatum), SeabugContract)
...
marketPlaceListNft
  :: SeabugContract (Array NftResult)
marketPlaceListNft = do
  ...
  lift do
    ...
    scriptAddr <-
      liftContractM
        "marketPlaceListNft: Cannot convert validator hash to address"
